...
var onclickListener = function(evt) {
	...
	document.getElementById("todo").value = barva;
	document.getElementById("todo").select();
	document.getElementById("barvadiv").style.backgroundColor=barva;
	istat=!istat;
	var n_match  = ntc.name(todo.value);
	 n_name       = n_match[3]+ ": "+ n_match[1]; // Text string: Color name
	 document.getElementById("huename").value = n_name;
	document.getElementById("huename").select();
